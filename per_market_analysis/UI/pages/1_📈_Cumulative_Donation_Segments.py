"""Page 2: Cumulative Segments visualization."""
...
from utils.plot_generators import plot_cumulative_segments

st.set_page_config(page_title="Cumulative Donation Segments", page_icon="📈", layout="wide")

st.title("📈 Cumulative Donation Segments")
st.markdown("Cumulative donation ratios broken down by donor segment (Small/Medium/Large).")
...
# Segment selector
available_segs = get_available_segments(slug_dir, selected_frequency, cumulative=True)
...
try:
    ...
    if fig.data:
        ...
        show_calculation_panel("cumulative_segments", selected_slug, selected_frequency)
